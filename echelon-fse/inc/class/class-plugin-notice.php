  ...
  '1x' => 'https://ps.w.org/gutenverse-form/assets/icon-128x128.png?rev=3135966',
		...
		<style>
            .install-gutenverse-plugin-notice {
                ...
                background: url( <?php echo esc_url( ECHELON_FSE_URI . '/assets/img/background-banner.png' ); ?> );
        ...
        jQuery( function( $ ) {
            $( 'div.notice.install-gutenverse-plugin-notice' ).on( 'click', 'button.notice-dismiss', function( event ) {
                ...
                $.post( ajaxurl, {
                    ...
                    nonce: '<?php echo esc_html( wp_create_nonce( 'echelon-fse_admin_notice' ) ); ?>',
                } );
            } );
            ...
            <div class="gutenverse-notice-inner">
                <div class="gutenverse-notice-content">
                    <div class="gutenverse-notice-text">
                        <h3><?php esc_html_e( 'Take Your Website To New Height with', 'echelon-fse' ); ?> <span>Gutenverse!</span></h3> 
                        <p><?php esc_html_e( 'Echelon FSE theme work best with Gutenverse plugin. By installing Gutenverse plugin you may access Echelon FSE templates built with Gutenverse and get access to more than 40 free blocks, hundred free Layout and Section.', 'echelon-fse' ); ?></p>
                        <div class="gutenverse-bottom">
                            <a class="gutenverse-button" id="gutenverse-install-plugin" href="<?php echo esc_url( wp_nonce_url( self_admin_url( 'themes.php?page=echelon-fse-dashboard' ), 'install-plugin_gutenverse' ) ); ?>">
                                <?php echo esc_html( __( 'Install Required Plugins', 'echelon-fse' ) ); ?>
                            </a>
                        </div>
                    </div>
                    <div class="gutenverse-notice-image">
                        <img src="<?php echo esc_url( ECHELON_FSE_URI . '/assets/img/banner-install-gutenverse.png' ); ?>"/>
                    </div>
                </div>
            </div>
        </div>
