...
/**
 * Autoloader function for Echelon FSE theme classes
 *
 * @param string $class The fully-qualified class name.
 * @return void
 */
function echelon_fse_autoloader( $class ) {
    $prefix   = 'Echelon_Fse';
    $base_dir = ECHELON_FSE_DIR . 'inc/class/';
    $len      = strlen( $prefix );
...
spl_autoload_register( 'echelon_fse_autoloader' );